...
import in.conceptarchitect.banking.exceptionhandling.BankingException;
import in.conceptarchitect.banking.exceptionhandling.InvalidDenominationException;
...
public class ATM {
	...
	private void dispenseCash(int amount) {
		...
		if(amount%100==0) { //if not a multiple of 100
			...
			throw new InvalidDenominationException("try a multiple of 100: "+amount);
		}
